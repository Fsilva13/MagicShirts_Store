    ...
    <fieldset>
      ...
      <div class="row justify-content-center">
        ...
        <div class="form-group col-7">
          ...
          <div>
            <input name="nome" type="text" placeholder="" class="form-control input-md" value="{{old('nome') ?? $estampa->nome ?? ''}}">
            @error('nome')
            <div class="error">
              {{$message}}
            </div>
        ...
        <div class="form-group col-7">
          ...
          <div>
            <textarea rows="4" style="resize:none;" type="text-area" class="form-control" id="descricao" name="descricao" value="">{{old('descricao') ?? $estampa->descricao ?? '' }}</textarea>
            @error('descricao')
            <div class="error">
              {{$message}}
            </div>
